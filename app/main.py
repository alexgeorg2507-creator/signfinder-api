...
from app.routers import llm_config, signature_process, corpus, agent, me, deals, deals_public, deals_internal, feedback
...
app.include_router(deals_internal.router)
